...
empty = pygame.image.load("empty_sprite.png").convert()
mine = pygame.image.load("mine_sprite.png").convert()
tiles = pygame.sprite.Group()
empties = pygame.sprite.Group()
...
def generate_grid(SIZE):
            ...
            if nearby_mines == 0:
                for tile in tiles:
                    if tile.rect.collidepoint(c_x,c_y-20):
                        if tile.state != 3:
                            tile.revealed = True
                    elif tile.rect.collidepoint(c_x+20,c_y-20):
                        if tile.state != 3:
                            tile.revealed = True
                    elif tile.rect.collidepoint(c_x+20,c_y):
                        if tile.state != 3:
                            tile.revealed = True
                    elif tile.rect.collidepoint(c_x+20,c_y+20):
                        if tile.state != 3:
                            tile.revealed = True
                    elif tile.rect.collidepoint(c_x,c_y+20):
                        if tile.state != 3:
                            tile.revealed = True
                    elif tile.rect.collidepoint(c_x-20,c_y+20):
                        if tile.state != 3:
    ...
    display = pygame.display.set_mode((legacy_x+100,y+100), flags)
